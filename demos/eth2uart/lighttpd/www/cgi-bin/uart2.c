...
int main(int argc, char * const argv[])
{
	...
	printf("UART settings:\n\n");
		...
		printf("Port<INPUT SIZE=10 VALUE= \"2\" NAME=\"ur_port\">(1~8)<BR>");
		...
		printf("Flow Control<INPUT SIZE=10 VALUE = \"0\" NAME=\"ur_flow\">(0:none, 1:hardware, 2:Xon/Xoff)<BR>");
		printf("RS485<INPUT SIZE=10 VALUE = \"0\" NAME=\"ur_485\">(0:Disable, 1:Enable)<BR>");
		...
		printf("<FORM METHOD=\"GET\" ACTION=\"uart.cgi\">");
		printf("Port<INPUT SIZE=10 VALUE= \"%ld\" NAME=\"ur_port\">(1~8)<BR>",ur_port);
		...
		printf("Flow Control<INPUT SIZE=10 VALUE = \"%ld\" NAME=\"ur_flow\">(0:none, 1:hardware, 2:Xon/Xoff)<BR>",ur_flow);
		printf("RS485<INPUT SIZE=10 VALUE = \"%ld\" NAME=\"ur_485\">(0:Disable, 1:Enable)<BR>",ur_485);
		printf("<INPUT TYPE=\"submit\" VALUE=\"Submit\">");
		printf("</FORM>");
	}
